  ...
  return (
    <Layout backgroundImage='/images/bg-deschooling.png'>
      ...
      <div className=' h-screen '>
        <div className='flex h-[70%] w-full flex-col space-y-8 px-44 py-10'>
          <div className=' flex flex-row items-center justify-center rounded-b-xl  rounded-t-xl  border  border-dotted p-4  text-4xl'>
          ...
          <div className='flex flex-row items-center justify-center '>
            <div className=' text-xl leading-10 text-white'>
              <p className='text-center indent-10'>
              ...
              <p className='mx-2 mt-4 text-center font-mono text-2xl font-extrabold text-[#ffcc00] '>
